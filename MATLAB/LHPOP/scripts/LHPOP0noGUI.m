...
%% SPICE LIBRARIES
    % ==================================================================================================================================================
    ts = cputime;
    HarmD = 350; % e-3 , maximum degree of the harmonics
    HarmO = 350; % e-3 , maximum order of the harmonics (set 0 for only zonal harmonics)
    ...
    TStart = '2020 Feb 06 00:00:00.000';  % start time [yyyy month dd hh:mm:ss.---]
    % TStart = '2022 Nov 25 00:00:00.000';  % start time [yyyy month dd hh:mm:ss.---]
    % TStart = '2022 Nov 27 01:42:00.000';  % start time [yyyy month dd hh:mm:ss.---]
    TStop =  '2020 Feb 10 00:00:00.000';  % stop time [yyyy month dd hh:mm:ss.---]
    ...
    orb.pointMasses.M(3)  = 1.89813e27*isJ;     % Mass of the Jupiter                                     [kg]
...
%% Analisys start time and stop time
    % ==================================================================================================================================================
    orb.epoch.start = TStart;                                                   % start time [yyyy month dd hh:mm:ss.---]
    orb.epoch.stop  = TStop;   % stop  time [yyyy month dd hh:mm:ss.---]
    % ==================================================================================================================================================
