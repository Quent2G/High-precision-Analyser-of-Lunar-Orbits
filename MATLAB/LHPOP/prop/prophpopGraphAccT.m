function [X] = prophpopGraphAccT(t,X0,model)
    ...
    fprintf(TextAcc, "LunGrav   "+t+"   "+num2str(norm(acc_centralPlanet))+"\n");
    % ---------------------------------------------------------------------------------------------------------- %   
    ...
    fprintf(TextAcc, "RelatCorr   "+t+"   "+num2str(norm(acc_genRel))+"\n");
    ...
    fprintf(TextAcc, "SunRadPress   "+t+"   "+num2str(norm(acc_SRPSun))+"\n");
    % ---------------------------------------------------------------------------------------------------------- %
    ...
    fprintf(TextAcc, "EarthAlb   "+t+"   "+num2str(norm(acc_alb))+"\n");
    % ---------------------------------------------------------------------------------------------------------- %
